...
int main(int argc, char **argv) {
    ...
    cimg_forXY(promediada_roberts,x,y){
        ...
        if ( promediada_sobel(x,y) < 0 ) promediada_sobel(x,y)=0;
        if ( parecida_sobel(x,y) < 0 ) parecida_sobel(x,y)=0;
        if ( distinta_sobel(x,y) < 0 ) distinta_sobel(x,y)=0;

        if ( promediada_laplaciano_g(x,y) < 0 ) promediada_laplaciano_g(x,y)=0;
        if ( parecida_laplaciano_g(x,y) < 0 ) parecida_laplaciano_g(x,y)=0;
        if ( distinta_laplaciano_g(x,y) < 0 ) distinta_laplaciano_g(x,y)=0;

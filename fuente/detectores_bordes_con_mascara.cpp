 ...
 * y segmentadas, pero con la mascara binaria formada por la
 * promediada (base) y las imagenes a comparar sin tocar.
 *
 * pruebas:
 * ../detectores_bordes_binario  -size 50 -seg 10 -ver 1
 * 
 * conclusines
 * Da un mayor error (MSE) con la imagen parecida que con la
 * distinta. 
 * 
*/
...
int main(int argc, char **argv) {
    ...
    CImg<double> parecida_roberts   = img1;
    CImg<double> distinta_roberts   = img2;

    CImg<double> promediada_sobel = filtrado_sobel(promediada);
    CImg<double> parecida_sobel   = img1;
    CImg<double> distinta_sobel   = img2;

    CImg<double> promediada_laplaciano_g = filtrado_laplaciano_g(promediada);
    CImg<double> parecida_laplaciano_g   = img1;
    CImg<double> distinta_laplaciano_g   = img2;

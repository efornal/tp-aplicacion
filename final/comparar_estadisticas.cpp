...
struct extract_test : public ExtractorCaracteristicas {
  explicit  extract_test() : ExtractorCaracteristicas() {}
  CImg<double> extraer_caracteristicas( CImg<double> imagen );
};


CImg<double> extract_test::extraer_caracteristicas( CImg<double> imagen ) {
  return CImg<double> estadisticas_imagen<double>( imagen );
}

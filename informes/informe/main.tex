...
\item Se obtiene una imagen de sólo bordes aplicando operador gradiente de
      Sobel (\ref{sob}), donde $G_x$, $G_y$ son el resultado de aplicar las
      máscaras respectivas $[G_x]$ y $[G_y]$ a la imagen por separado luego se umbraliza en el valor $U$ como en
      \ref{umbral}.

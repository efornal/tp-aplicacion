...
de interés, para poder obtener información pertinente
...
Como resultado, se obtiene un vector de 45 características a partir de histogramas que se
...
por Canny \cite{canny} \resalt{que tiene de bueno el de canny?}, así como
también técnicas de preprocesamiento de la
